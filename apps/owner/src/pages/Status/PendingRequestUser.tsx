        ...
        <div className='mb-6'>
          ...
          >
            <div className='flex flex-col gap-3'>
              <p className='text-caption text-gray-700'>{formatDate(activePet.createdAt)} 견적요청</p>
              <h3 className='text-sub_h3'>{activePet.petName || '이름 없음'}</h3>
              <div className='text-iconCaption'>
                <div className='flex'>
                  <div className='mr-2 flex min-w-[50px] flex-col'>
                    <div className='flex items-center justify-center'>
                      <p className='h-[16px] min-w-[44px] rounded-sm border border-primary px-2 py-[0.8px] text-primary'>
                        서비스
                      </p>
                    </div>
